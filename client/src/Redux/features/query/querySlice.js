...
const queriesSlice = createSlice({
    ...
    extraReducers : (builder) => {
        ...
        .addCase(getQueries.fulfilled , (state , action)=>{
            state.allQueries=action.payload.allQueries
            state.isQueryError = false
            state.isQueryLoading = false
...
export const deleteQuery = createAsyncThunk('/deleteQuery' , async(itemId, thunkAPI)=>{

    try {
        return await queriesService.deleteQuery(itemId)
